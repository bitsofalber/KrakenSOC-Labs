...
flag REAL vive en el secret de GitHub Actions `BATTERING_RAM_TOKEN` y se inyecta en
la imagen del forge SOLO durante el build de CI
(`.github/workflows/release-battering-ram.yml`). Así la flag nunca está en el
